...
files_gpx = list.files("/Users/annebozack/Downloads/export_19836728 (1)/activities", pattern = "gpx.gz$", full = TRUE)
files_fit = list.files("/Users/annebozack/Downloads/export_19836728 (1)/activities", pattern = "fit.gz$", full = TRUE)

files = c(files_gpx, files_fit)
sapply(files, gunzip, overwrite = TRUE)

files_gpx = list.files("/Users/annebozack/Downloads/export_19836728 (1)/activities", pattern = "gpx$", full = TRUE)
files_fit = list.files("/Users/annebozack/Downloads/export_19836728 (1)/activities", pattern = "fit$", full = TRUE)
...
activities = read.csv('/Users/annebozack/Downloads/export_19836728 (1)/activities.csv') 
...
anim_save("/Users/annebozack/Desktop/stravAnim2020_run_color.gif")
...
anim_save("/Users/annebozack/Desktop/stravAnim2020_bike_color.gif")
